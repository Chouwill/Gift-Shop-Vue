      ...
      <div class="modal-box w-11/12 max-w-2xl">
        ...
        <div class=" mt-7">
          <table class="table">
            ...
            <tbody>
              <!-- row 1 -->
              <tr v-for="(item, idx) in productStore.products" :key="item.id" class="hover:bg-amber-400 w-[90%]">
                <td class="" rowspan="1">
                  <div class="md:w-[254px] w-[100px] flex justify-start items-center gap-5 !border">
                    <div class="img-box">
                      <img
                        :src="item.image_url"
                        :alt="item.name"
